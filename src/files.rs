...
match the given specifications:
    ...
    -M  Print pathnames that refer to files whose modification times match the
        given *datetime* expression. Datetime expressions have 2 parts: a
        comparison operator (“>” for after, “<” for before, and “=” for exactly)
        and a datetime string. *files* first attempts to parse the string as
        “YYYY-MM-DD HH:MM:SS”, then as “HH:MM:SS”, then as “YYYY-MM-DD”.
